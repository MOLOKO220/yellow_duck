...
import RegionByServices from "../RegionByServices/RegionByServices";
  ...
  return (
    <section className="Second_section">
      <div className="container">
        <main>
          <div className="Second_section__info">
          ...
          <div className="Second_section__social">
            <h3>Ми у соц. мережах</h3>
            <div>
              <Link href={"twitter.com/stripe"}>
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
              ...
              <Link href={"facebook.com/StripeHQ"}>
                <svg
                  width="11"
                  height="20"
                  viewBox="0 0 11 20"
